...
% Set image directory
Params.imgDir{1} = fullfile(funcDir, 'images', 'facebookProfPics', 'IkezoeMasaki', 'selectedImages02');
Params.imgDir{2} = fullfile(funcDir, 'images', 'facebookProfPics', 'OkamotoMasahiro', 'selectedImages01');
